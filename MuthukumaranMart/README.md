...
```
com.muthukumaran.muthukumaranmart
...
mvn compile
mvn exec:java -Dexec.mainClass="com.muthukumaran.muthukumaranmart.util.DbSeeder"
mvn clean package
cp target/muthukumaranmart.war $CATALINA_HOME/webapps/
```
...
| Role | Email | Password |
|---|---|---|
| Admin | admin@muthukumaranmart.com | Admin@12345 |
| Seller | priya.seller@muthukumaranmart.com | Seller@123 |
| Seller | arjun.seller@muthukumaranmart.com | Seller@123 |
| Buyer | divya.buyer@muthukumaranmart.com | Buyer@1234 |
| Buyer | karthik.buyer@muthukumaranmart.com | Buyer@1234 |
...
- `gemini` - calls the Gemini API server-side using `ai.chatbot.apiKey`
  (never exposed to the browser). See `com.muthukumaran.muthukumaranmart.chat.GeminiChatProvider`.
