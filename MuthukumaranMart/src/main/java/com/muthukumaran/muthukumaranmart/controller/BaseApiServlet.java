...
import com.muthukumaran.muthukumaranmart.exception.ConflictException;
import com.muthukumaran.muthukumaranmart.exception.DataAccessException;
import com.muthukumaran.muthukumaranmart.exception.ForbiddenException;
import com.muthukumaran.muthukumaranmart.exception.NotFoundException;
import com.muthukumaran.muthukumaranmart.exception.UnauthorizedException;
import com.muthukumaran.muthukumaranmart.exception.ValidationException;
import com.muthukumaran.muthukumaranmart.filter.AuthFilter;
import com.muthukumaran.muthukumaranmart.listener.ServiceRegistry;
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (METHOD_PATCH.equalsIgnoreCase(req.getMethod())) {
            try {
                ...
                handleError(resp, new com.muthukumaran.muthukumaranmart.exception.DataAccessException("Unhandled error", e));
            }
            return;
        }
