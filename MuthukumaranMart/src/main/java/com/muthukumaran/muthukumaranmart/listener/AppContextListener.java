...
public class AppContextListener implements ServletContextListener {
    ...
    public static final String DATASOURCE_ATTR = "muthukumaranmart.datasource";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        config.setJdbcUrl(props.getProperty("db.url", "jdbc:h2:tcp://localhost:9092/./data/muthukumaranmart"));
        ...
        config.setPoolName("MuthukumaranMartPool");
