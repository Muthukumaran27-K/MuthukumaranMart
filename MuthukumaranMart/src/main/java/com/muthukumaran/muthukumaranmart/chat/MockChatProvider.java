package com.muthukumaran.muthukumaranmart.chat;
...
public class MockChatProvider implements ChatProvider {
    ...
    static {
        ...
        FAQ.put("seller", "To sell on MuthukumaranMart, register with the Seller role and add listings from your seller dashboard.");
    ...
    private String defaultReply() {
        return "I can help with questions about products, orders, shipping, returns, and reviews on MuthukumaranMart. "
